...
if "history" not in st.session_state:
    st.session_state.history = pd.DataFrame(columns=["Client","Case","Month","Year","Overpayment"])
...
if len(st.session_state.history) > 0:
    ...
    summary_row[export_df.columns[0]] = "TOTAL"
    summary_row[export_df.columns[-1]] = float(total)
